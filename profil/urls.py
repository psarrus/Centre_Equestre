...
from views import CreateProfil, ListProfil, ProfilDetail, ProfilUpdate, CreatePublic, ListPublic, PublicUpdate


urlpatterns = [
    url(r'^$', ListProfil.as_view(), name='list_profil'),
    url(r'^create$', CreateProfil.as_view(), name='create_profil'),
    url(r'^detail/(?P<pk>[\w-]+)$', ProfilDetail.as_view(), name='detail_profil'),
